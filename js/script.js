...
(function (global) {
  ...
  document.addEventListener("DOMContentLoaded", function (event) {
    ...
    // Fetch categories and build home HTML
    $ajaxUtils.sendGetRequest(
      allCategoriesUrl,
      buildAndShowHomeHTML, // Call buildAndShowHomeHTML when data is fetched
      true // Setting the flag to get JSON from server processed into an object literal
    );
  });
  ...
  function buildAndShowHomeHTML(categories) {
    ...
    $ajaxUtils.sendGetRequest(
      ...
      false // False here because we are getting just regular HTML from the server, no need to process JSON.
    );
  }
